...
// generate time: 2024-03-14 12:58:15
// src code version: 
...
func (s *TestA) GetC() *mdata.MList[int] {
	return s.c
}
func (s *TestA) SetC(v *mdata.MList[int]) {
	s.c = v
	s.UpdateDirty(3)
	if v != nil {
...
func (s *TestA) GetD() *mdata.MMap[int, int] {
	return s.d
}
func (s *TestA) SetD(v *mdata.MMap[int, int]) {
	s.d = v
	s.UpdateDirty(4)
	if v != nil {
